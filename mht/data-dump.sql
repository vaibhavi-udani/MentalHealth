...
CREATE TABLE `dailygoals` (
  ...
  KEY `user_id` (`user_id`),
  CONSTRAINT `dailygoals_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `userslumo` (`user_id`)
...
DROP TABLE IF EXISTS `longgoals`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `longgoals` (
  ...
  KEY `user_id` (`user_id`),
  CONSTRAINT `longgoals_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `userslumo` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `message` (
  ...
  CONSTRAINT `message_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `userslumo` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
DROP TABLE IF EXISTS `scoreslumo`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `scoreslumo` (
  ...
  `date` date DEFAULT NULL,
  KEY `user_id` (`user_id`),
  CONSTRAINT `scoreslumo_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `userslumo` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
DROP TABLE IF EXISTS `shortgoals`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `shortgoals` (
  ...
  `date` date NOT NULL,
  KEY `user_id` (`user_id`),
  CONSTRAINT `shortgoals_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `userslumo` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
DROP TABLE IF EXISTS `userslumo`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
-- Dump completed on 2018-12-23 16:02:40
